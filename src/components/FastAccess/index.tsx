        ...
        <>
            ...
            <View style={{ flexDirection: 'row' }}>
                <SmallContainer navigation={navigation}>
                    ...
                    <Text style={{ padding: 16, color: '#fff' }}>Extrato</Text>
                </SmallContainer>
                <SmallContainer navigation=''>
                    <FontAwesome name="money" size={45} color="#666666" />
                    <Text style={{ padding: 16, color: '#fff' }}>Transferencia</Text>
                </SmallContainer>
                <SmallContainer navigation=''>
            ...
            <View style={{ flexDirection: 'row', marginTop: 15 }}>
                <SmallContainer navigation=''>
                    ...
                    <Text style={{ padding: 16, color: '#fff' }}>Pagamentos</Text>
                </SmallContainer>
                <SmallContainer navigation=''>
                    <FontAwesome5 name="hand-holding-usd" size={45} color="#666666" />
                    <Text style={{ padding: 16, color: '#fff' }}>Emprestimos</Text>
                </SmallContainer>
                <SmallContainer navigation=''>
                    <Entypo name='line-graph' size={45} color="#666666" />
                    <Text style={{ padding: 16, color: '#fff' }}>Investimentos</Text>
                </SmallContainer>
            </View>
        </>
    )
